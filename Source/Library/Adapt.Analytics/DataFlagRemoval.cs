...
namespace Adapt.DataSources
{
    ...
    [Description("Data Flag: Removes values from the zero that have the Flag Set.")]
    public class DataFlagRemoval : BaseAnalytic, IAnalytic
    {
        ...
        public IEnumerable<AnalyticOutputDescriptor> Outputs()
        {
            return new List<AnalyticOutputDescriptor>() { 
                new AnalyticOutputDescriptor() { Name = "Cleaned", FramesPerSecond = 0, Phase = Phase.NONE, Type = MeasurementType.Other } 
            };
        }

        public IEnumerable<string> InputNames()
        {
            return new List<string>() { "Original", "Flag" };
        }
