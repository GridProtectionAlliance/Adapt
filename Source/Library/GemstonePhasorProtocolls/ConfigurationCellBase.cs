...
namespace GemstonePhasorProtocolls
{
    ...
    public abstract class ConfigurationCellBase : ChannelCellBase, IConfigurationCell
    {
        ...
        /// <summary>
        /// Gets or sets the nominal frequency of the <see cref="FrequencyDefinition"/> of this <see cref="ConfigurationCellBase"/>.
        /// </summary>
        public virtual double NominalFrequency
        {
        ...
        public override void GetObjectData(SerializationInfo info, StreamingContext context)
        {
            ...
            info.AddValue("nominalFrequency", m_nominalFrequency, typeof(double));
