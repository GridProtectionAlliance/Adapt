...
using Gemstone.Numeric.UInt24Extensions;
    ...
    public class DigitalDefinition : DigitalDefinitionBase
    {
        ...
        internal byte[] ConversionFactorImage
        {
            get
            {
                ...
                Gemstone.BigEndian.CopyBytes(m_normalStatus, buffer, 0);
                Gemstone.BigEndian.CopyBytes(m_validInputs, buffer, 2);
        ...
        {
            m_normalStatus = Gemstone.BigEndian.ToUInt16(buffer, startIndex);
            m_validInputs = Gemstone.BigEndian.ToUInt16(buffer, startIndex + 2);
