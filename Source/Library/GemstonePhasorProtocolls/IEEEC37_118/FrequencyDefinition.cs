...
namespace GemstonePhasorProtocolls.IEEEC37_118
{
    ...
    public sealed class FrequencyDefinition : FrequencyDefinitionBase
    {
        ...
        /// </summary>
        protected override byte[] BodyImage => BigEndian.GetBytes((ushort)(base.Parent.NominalFrequency == 50.0D ? Bits.Bit00 : Bits.Nil));
        ...
        {
            base.Parent.NominalFrequency = (BigEndian.ToUInt16(buffer, startIndex) & (ushort)Bits.Bit00) > 0 ? 50.0D : 60.0D;
            return 2;
        }
