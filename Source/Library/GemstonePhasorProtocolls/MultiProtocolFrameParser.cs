...
namespace GemstonePhasorProtocolls
{
    ...
    public sealed class MultiProtocolFrameParser : IFrameParser
    {
        ...
        private sealed class SharedUdpClientReference : IClient
        {
            ...
            // Fields
            private Gemstone.Communication.UdpClient m_udpClient;
        ...
        public PhasorProtocol PhasorProtocol
        {
            ...
            set
            {
                ...
                // this is removed because ADAPT only needed IEEEC37.118 possibly implement in the future as neccesarry
                switch (value)
                {
        ...
        public WaitHandle SendDeviceCommand(DeviceCommand command)
        {
            ...
            try
            {
                ...
                {
                    ICommandFrame commandFrame = null;
