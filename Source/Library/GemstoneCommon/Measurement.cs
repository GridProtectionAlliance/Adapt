...
namespace GemstoneCommon
{
    ...
    public class Measurement : IMeasurement
    {
        ...
        /// <summary>
        /// Gets the <see cref="string"/> based signal ID of the <see cref="Measurement"/> implementation.
        /// </summary>
        public string ID => m_metadata.Key.SignalID.ToString();
